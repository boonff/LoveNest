    ...
    event.create('minecraft:lightning_rod')
        .scene("lightning_test", "避雷针测试", (scene, util) => {
            ...
            for (let i = 0; i <= n; i++) {
                ...
                scene.world.setBlock(anvilPos, 'minecraft:air', false)
                scene.particles.block(5, 'minecraft:anvil', anvilPos);
            ...
            scene.particles.block(5, "minecraft:lightning_rod", [
                RodPos[0] + 0.5,
                RodPos[1],
                RodPos[2] + 0.5
            ]);
            anvilDrop(scene, 'anvilcraft:transcendence_anvil', AnvilDown, AnvilDownDown)
